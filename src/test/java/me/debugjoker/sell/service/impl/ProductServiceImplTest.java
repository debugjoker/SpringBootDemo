...
public class ProductServiceImplTest {
    ...
    @Test
    public void onSale() {
        ProductInfo product = productService.onSale("1214413");
        Assert.assertEquals(ProductStatusEnum.UP, product.getProductStatusEnum());
    }

    @Test
    public void offSale() {
        ProductInfo product = productService.offSale("1214413");
        Assert.assertEquals(ProductStatusEnum.DOWN, product.getProductStatusEnum());
    }
}